...
void printDebug(dynamic message, {String? tag, bool timestamp = true, bool debugOverride = kDebugMode}) {
  if (debugOverride) {
    _print(message.toString(), tag: tag, logLevel: LogLevel.debug, timestamp: timestamp);
  }
}
...
/// The [toString()] function is called on the [message] object to convert to a string.
/// If `debugOverride` is set to `false`, the message will not be printed.
void printInfo(dynamic message, {String? tag, bool timestamp = true, bool debugOverride = kDebugMode}) {
  if (debugOverride) {
    _print(message.toString(), tag: tag, logLevel: LogLevel.info, timestamp: timestamp);
  }
}
...
/// The [toString()] function is called on the [message] object to convert to a string.
/// If `debugOverride` is set to `false`, the message will not be printed.
void printWarning(dynamic message, {String? tag, bool timestamp = true, bool debugOverride = kDebugMode}) {
  if(debugOverride) {
    _print(message.toString(), tag: tag, logLevel: LogLevel.warning, timestamp: timestamp);
  }
}
...
/// The [toString()] function is called on the [message] object to convert to a string.
/// If `debugOverride` is set to `false`, the message will not be printed.
void printError(dynamic message, {String? tag, bool timestamp = true, bool debugOverride = kDebugMode}) {
  if(debugOverride) {
    _print(message.toString(), tag: tag, logLevel: LogLevel.error, timestamp: timestamp);
  }
}
...
void _print(String message, {LogLevel logLevel = LogLevel.debug, String? tag, bool timestamp = true}) {
  ...
  final tags = [appTag, tag].where((element) => element != null).map((e) => "[$e]").join(" ");
  String time = "";
  if (timestamp) {
